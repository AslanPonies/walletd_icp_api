...
import { idlFactory } from './walletd_icp_api.did.js';
export { idlFactory } from './walletd_icp_api.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WALLETD_ICP_API;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./walletd_icp_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the walletd_icp_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./walletd_icp_api.did.js")._SERVICE>}
 */
export const walletd_icp_api = createActor(canisterId);
